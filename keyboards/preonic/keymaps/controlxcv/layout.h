...
#define KEYMAP_RISE LAYOUT_preonic_1x2uC( \
    KC_LANG2,   XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_LBRC,    KC_RBRC,    XXXXXXX, \
    ...
    _______,    _______,    _______,    _______,    _______,          XXXXXXX,          KC_BSPC,    KC_DEL,     KC_MPRV,    KC_MNXT,    KC_MPLY \
)
...
#define KEYMAP_LOWR LAYOUT_preonic_1x2uC( \
    ...
    _______,    _______,    _______,    _______,    _______,          XXXXXXX,          KC_HOME,    KC_END,     KC_PGDN,    KC_PGUP,    KC_PENT \
)
