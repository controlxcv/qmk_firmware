...
#define KEYMAP_COMMON LAYOUT_preonic_grid( \
	...
	_KC_LOWR,	KC_LCTL,	KC_LALT,	KC_LGUI,	_KC_RISE,	KC_SPC,		KC_SPC,		KC_ENT,		KC_LEFT,	KC_DOWN,	KC_UP,		KC_RGHT		\
)
...
#define KEYMAP_ADJUST LAYOUT_preonic_grid( \
	...
	XXXXXXX,	_KC_QWER,	_KC_COLE,	_KC_DVOR,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	\
