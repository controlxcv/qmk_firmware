...
#define KEYMAP_COMM LAYOUT_preonic_1x2uC( \
    ...
    MO(_LOWR),  KC_LCTL,    KC_LALT,    MO(_RISE),  KC_LGUI,          KC_SPC,           KC_ENT,     KC_LEFT,    KC_RGHT,    KC_DOWN,    KC_UP \
)

#define KEYMAP_RISE LAYOUT_preonic_1x2uC( \
    KC_LANG2,   _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_LBRC,    KC_RBRC,    KC_MUTE, \
    ...
    _______,    _______,    _______,    _______,    _______,          _______,          _______,    KC_BSPC,    KC_DEL,     KC_MPRV,    KC_MNXT \
)
...
#define KEYMAP_LOWR LAYOUT_preonic_1x2uC( \
    ...
    _______,    _______,    _______,    _______,    _______,          _______,          _______,    KC_HOME,    KC_END,     KC_PGDN,    KC_PGUP \
)
