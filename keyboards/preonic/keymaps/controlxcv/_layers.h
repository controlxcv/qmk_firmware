...
#define KEYMAP_COMM LAYOUT_preonic_1x2uC( \
    ...
    MO(_LOWR),  KC_LCTL,    KC_LALT,    KC_LGUI,    MO(_RISE),        KC_SPC,           KC_LEFT,    KC_RGHT,    KC_DOWN,    KC_UP,      KC_ENT \
)
...
#define KEYMAP_RISE LAYOUT_preonic_1x2uC( \
    ...
    _______,    _______,    _______,    _______,    _______,          _______,          KC_BSPC,    KC_DEL,     KC_MPRV,    KC_MNXT,    KC_MPLY \
)
