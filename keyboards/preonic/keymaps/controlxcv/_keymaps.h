...
#define KEYMAP_COMM LAYOUT_preonic_1x2uC( \
    ...
    MO(_LOWR),  KC_LCTL,    KC_LOPT,    KC_LCMD,    MO(_RISE),        KC_SPC,           KC_LEFT,    KC_DOWN,    KC_UP,      KC_RGHT,    KC_ENT \
)
...
#define KEYMAP_LOWR LAYOUT_preonic_1x2uC( \
    ...
    _______,    _______,    _______,    _______,    _______,          XXXXXXX,          KC_MRWD,    KC_VOLD,    KC_VOLU,    KC_MFFD,    KC_MPLY \
)
