...
#define KEYMAP_QWERTY LAYOUT_preonic_grid( \
    ...
    KC_LSFT, KC_SLSH, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_QUOT, \
    KC_LCTL, KC_LALT, KC_LGUI, RAISE,   LOWER,   KC_SPC,  KC_SPC,  KC_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
)
...
#define KEYMAP_COLEMAK LAYOUT_preonic_grid( \
    ...
    KC_LSFT, KC_SLSH, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_QUOT, \
    KC_LCTL, KC_LALT, KC_LGUI, RAISE,   LOWER,   KC_SPC,  KC_SPC,  KC_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
)
...
#define KEYMAP_RAISE LAYOUT_preonic_grid( \
    ...
    KC_LANG2, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, S(A(KC_VOLU)), \
    KC_LANG1, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, S(A(KC_VOLD)), \
    _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
