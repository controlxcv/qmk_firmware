...
#define KEYMAP_QMKB LAYOUT_preonic_1x2uC( \
    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    DF(_DVOR),  DF(_QWER),  DF(_COLE),  EEP_RST, \
    ...
    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    RGB_M_T,    RGB_SAD,    RGB_SAI,    RGB_M_P,    RGB_M_SW, \
    XXXXXXX,    XXXXXXX,    _______,    XXXXXXX,    MO(_RSET),        XXXXXXX,          RGB_HUD,    RGB_VAD,    RGB_VAI,    RGB_HUI,    RGB_TOG \
)
...
#define KEYMAP_RSET LAYOUT_preonic_1x2uC( \
    ...
    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX, \
    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX, \
    XXXXXXX,    XXXXXXX,    _______,    XXXXXXX,    _______,          XXXXXXX,          XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    EEP_RST \
)
