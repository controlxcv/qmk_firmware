...
#define \
    ...
    LAYOUT_preonic_1x2uC( \
        ...
        MO(_RAISE), MO(_LOWER), KC_LGUI,    KC_LALT,    KC_LCTL,          KC_SPC,           KC_ENT,     KC_LEFT,    KC_RGHT,    KC_DOWN,    KC_UP)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_preonic_1x2uC(
        ...
        _______,    XXXXXXX,    _______,    _______,    _______,          XXXXXXX,          KC_INS,     KC_HOME,    KC_END,     KC_PGDN,    KC_PGUP),

    [_LOWER] = LAYOUT_preonic_1x2uC(
        MO(_RESET), XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    RGB_M_P,    RGB_M_R,    RGB_M_SW,   RGB_M_T,
