...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_preonic_1x2uC(
        ...
        MO(_XTND),  MO(_QMKB),  KC_LGUI,    KC_LALT,    KC_LCTL,          KC_SPC,           KC_LEFT,    KC_DOWN,    KC_UP,      KC_RGHT,    KC_ENT
    ),
    ...
    [_QMKB] = LAYOUT_preonic_1x2uC(
        ...
        XXXXXXX,    _______,    XXXXXXX,    XXXXXXX,    XXXXXXX,          XXXXXXX,          RGB_HUD,    RGB_VAD,    RGB_VAI,    RGB_HUI,    XXXXXXX
    ),
