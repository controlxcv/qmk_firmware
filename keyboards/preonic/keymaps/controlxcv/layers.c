...
#define \
    ...
    LAYOUT_preonic_1x2uC( \
        ...
        MO(_XTND),  MO(_QMKB),  KC_LGUI,    KC_LALT,    KC_LCTL,          KC_SPC,           KC_ENT,     KC_UP,      KC_DOWN,    KC_LEFT,    KC_RGHT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_XTND] = LAYOUT_preonic_1x2uC(
        ...
        _______,    XXXXXXX,    _______,    _______,    _______,          XXXXXXX,          XXXXXXX,    KC_PGUP,    KC_PGDN,    KC_HOME,    KC_END),
    ...
    [_QMKB] = LAYOUT_preonic_1x2uC(
        ...
        XXXXXXX,    _______,    XXXXXXX,    XXXXXXX,    XXXXXXX,          XXXXXXX,          XXXXXXX,    RGB_VAI,    RGB_VAD,    RGB_HUD,    RGB_HUI),
