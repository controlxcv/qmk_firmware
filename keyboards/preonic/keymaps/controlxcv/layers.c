...
#define LAYOUT_preonic_controlxcv( \
    ...
    LAYOUT_preonic_1x2uC( \
        ...
        MO(_QMKB),  MO(_XTND),  KC_LCMD,    KC_LOPT,    KC_LCTL,          KC_SPC,           KC_ENT,     KC_DOWN,    KC_UP,      KC_LEFT,    KC_RGHT \
    )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QMKB] = LAYOUT_preonic_1x2uC(
        ...
        XXXXXXX,    DF(_COLE),  DF(_QWER),  DF(_DVOR),  XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    RGB_TOG,
